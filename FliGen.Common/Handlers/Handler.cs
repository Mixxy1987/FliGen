...
namespace FliGen.Common.Handlers
{
	public class Handler : IHandler
	{
        ...
        private Func<FliGenException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<FliGenException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (FliGenException customException)
            {
                isFailure = true;
